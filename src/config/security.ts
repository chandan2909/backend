...
const rawOrigins = (env.FRONTEND_URL || env.CORS_ORIGIN || 'http://localhost:3000,http://localhost:5173,https://chandanpathak.dev,https://frontend-react-steel.vercel.app').split(',').map(o => o.trim());
