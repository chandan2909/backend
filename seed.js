        ...
        sections
          {
            ...
            videos
              { title: 'Lecture 0 Thinking & Scratch', url: 'https://www.youtube.com/watch?v=8mAITcNt710' },
          ...
          },
          {
            ...
            videos
              { title: 'Lecture 1 Programming Basics', url: 'https://www.youtube.com/watch?v=e9Eds2Rc_x8' },
          ...
          },
          {
            title: 'Week 2 – Arrays',
            videos
              { title: 'Lecture 2 & Memory', url: 'https://www.youtube.com/watch?v=4vU4aEFmTSo' },
          ...
          },
          {
            ...
            videos
              { title: 'Lecture 3 (Searching & Sorting)', url: 'https://www.youtube.com/watch?v=jZzyERW7h1A' },
          ...
          },
          {
            ...
            videos
              { title: 'Lecture 4 Allocation', url: 'https://www.youtube.com/watch?v=F9-yqoS7b8w' },
          ...
          },
          {
            ...
            videos
              { title: 'Lecture 5 Lists, Trees, Hash Tables', url: 'https://www.youtube.com/watch?v=0euvEdPwQnQ' },
          ...
          },
          {
            title: 'Week 6 – Python',
            videos
              { title: 'Lecture 6 Basics', url: 'https://www.youtube.com/watch?v=hnDU1G9FkvI' },
        ...
        sections
          {
            ...
            videos
              { title: 'Lecture 1 is Computation?', url: 'https://www.youtube.com/watch?v=nykOeWgQcHM' },
              { title: 'Lecture 2 and Iteration', url: 'https://www.youtube.com/watch?v=C0DPdy98e4c' },
              { title: 'Lecture 3 Manipulation, Guess and Check', url: 'https://www.youtube.com/watch?v=SE4P7IVCunE' },
            ]
          },
          {
            title: 'Functions and Abstraction',
            videos
              { title: 'Lecture 4, Abstraction, and Functions', url: 'https://www.youtube.com/watch?v=MjbuarJ7SE0' },
              { title: 'Lecture 5, Lists, Aliasing, Cloning', url: 'https://www.youtube.com/watch?v=RvRKT-jXvko' },
              { title: 'Lecture 6, Dictionaries', url: 'https://www.youtube.com/watch?v=WPSeyjX1-4s' },
            ]
          },
          {
            title: 'Testing, Debugging, and OOP',
            videos
              { title: 'Lecture 7, Debugging, Exceptions', url: 'https://www.youtube.com/watch?v=9H6mioroza0' },
              { title: 'Lecture 8-Oriented Programming', url: 'https://www.youtube.com/watch?v=-DP1i2ZU9gk' },
              { title: 'Lecture 9 Classes and Inheritance', url: 'https://www.youtube.com/watch?v=FlGjISF3l78' },
              { title: 'Lecture 10 Program Efficiency', url: 'https://www.youtube.com/watch?v=o9nW0uBqvEo' },
            ]
          },
          {
            title: 'Sorting, Complexity & Searching',
            videos
              { title: 'Lecture 11 Program Efficiency, Part 2', url: 'https://www.youtube.com/watch?v=7lQXYl_L28w' },
              { title: 'Lecture 12 and Sorting', url: 'https://www.youtube.com/watch?v=6LOwPhPDwVc' },
            ]
          },
          {
            title: 'Plotting and Data',
            videos
              { title: 'Lecture 13 of Data', url: 'https://www.youtube.com/watch?v=V5JPPwOjjok' },
              { title: 'Lecture 14 Thinking', url: 'https://www.youtube.com/watch?v=_M4_Vc_9JWk' },
              { title: 'Lecture 15 Walks', url: 'https://www.youtube.com/watch?v=6F9ubFsNORs' },
              { title: 'Lecture 16 Carlo Simulations', url: 'https://www.youtube.com/watch?v=GxCXiSkm6no' },
            ]
          },
        ]
      },
      ...
      // ─────────────────────────────────────────────────────────────────────
      {
        ...
        sections
          ...
          },
          {
            ...
            videos
              { title: 'Model Evaluation Matrix, Precision, Recall', url: 'https://www.youtube.com/watch?v=Kdsp6soqA7o' },
              { title: 'Overfitting & Regularization Explained', url: 'https://www.youtube.com/watch?v=EehRcPo1M-Q' },
              { title: 'ML Project House Prices', url: 'https://www.youtube.com/watch?v=29ZQ3TDGgRQ' },
